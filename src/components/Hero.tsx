...
const Hero = () => {
  return (
    <section className="pt-28 pb-20 md:pt-40 md:pb-28 relative overflow-hidden min-h-[90vh]">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 h-full flex items-center">
        <div className="flex flex-col md:grid md:grid-cols-2 gap-12 items-center w-full">
          {/* Mobile: Carousel appears first */}
          <div className="w-full md:hidden animate-fade-in-1 mb-8">
            <HeroCarousel />
          </div>

          <div className="animate-fade-in-1 flex flex-col justify-center">
          ...
          <div className="hidden md:block relative animate-fade-in-2 aspect-square">
